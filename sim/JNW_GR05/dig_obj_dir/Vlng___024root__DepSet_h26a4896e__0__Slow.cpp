...
VL_ATTR_COLD void Vlng___024root___ctor_var_reset(Vlng___024root* vlSelf) {
    ...
    vlSelf->pins = VL_RAND_RESET_I(8);
    vlSelf->reset = VL_RAND_RESET_I(1);
    vlSelf->temperature = VL_RAND_RESET_I(8);
    vlSelf->temp_capture__DOT__counter = VL_RAND_RESET_I(20);
    vlSelf->temp_capture__DOT__captured_value = VL_RAND_RESET_I(8);
    vlSelf->temp_capture__DOT__state = VL_RAND_RESET_I(2);
