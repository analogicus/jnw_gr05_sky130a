...
N 65 -40 355 -40 {lab=VSS}
N -270 -600 -30 -600 {lab=V_current_drive}
N 180 -900 180 -650 {lab=VDD_1V8}
...
N -100 -200 -100 -40 {lab=VSS}
N -140 -90 -100 -90 {lab=VSS}
N -140 -360 -100 -360 {lab=sys_out}
N -100 -360 -100 -270 {lab=sys_out}
N 160 -165 160 -45 {lab=VSS}
N -100 -360 -20 -360 {lab=sys_out}
N -110 -900 140 -900 {lab=VDD_1V8}
N 160 -390 340 -390 {lab=V_cap}
N 300 -120 320 -120 {lab=VSS}
N 300 -120 300 -40 {lab=VSS}
N 320 -90 320 -40 {lab=VSS}
...
C {JNW_TR_SKY130A/JNWTR_CAPX4.sym} 160 -225 2 0 {name=x2[0:5]}
...
C {sky130_fd_pr/pnp_05v5.sym} -160 -90 0 1 {name=Q2
model=pnp_05v5_W3p40L3p40
m=1
spiceprefix=X
}
C {JNW_TR_SKY130A/JNWTR_CAPX4.sym} -100 -260 2 0 {name=x1}
